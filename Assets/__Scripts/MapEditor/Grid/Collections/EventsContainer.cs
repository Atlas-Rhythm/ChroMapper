...
public class EventsContainer : BeatmapObjectContainerCollection
{
    ...
    public override BeatmapObjectContainer SpawnObject(BeatmapObject obj, out BeatmapObjectContainer conflicting, bool removeConflicting = false)
    {
        ...
        BeatmapEventContainer beatmapEvent = BeatmapEventContainer.SpawnEvent(this, obj as MapEvent, AudioTimeSyncController, ref eventPrefab, ref eventAppearanceSO, ref tracksManager);
